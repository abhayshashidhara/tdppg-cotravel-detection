...
2. Select the most active users to keep the experiment computationally manageable.
...
5. Aggregate user-pair features:
   ...
   * distinct days
   * shared venues
6. Build a weighted Temporal Detailed People Proximity Graph.
7. Filter weak edges from the graph.
...
1. `notebooks/gowalla_sensitivity_only.ipynb`
2. `notebooks/brightkite_sensitivity_only.ipynb`
